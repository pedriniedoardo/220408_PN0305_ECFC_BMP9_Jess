...
GOI <- c("TCF4","ADGRL4","MYH9","GJA1","CD93","CCDC85B")
...
pdf("../../out/plot/heatmap_GOI_03.pdf",width = 6,height = 4) 
...
ggsave("../../out/plot/boxplot_GOI_03.pdf",width = 6,height = 4) 
...
counts(data,normalized=T)%>%
  ...
  theme(strip.background = element_blank(), 
        panel.border = element_rect(colour = "black", fill = NA))
ggsave("../../out/plot/scatterplot_GOI_03.pdf",width = 6,height = 4)
