...
ggsave("../../out/image/GSEA_unbiased_res_BMP9_vs_Mock_shr_nonredundant_KEGG.pdf",width = 20,height = 12)
...
ggsave(filename = "../../out/image/GSEA_plot_profile_BMP9_vs_Mock_shr_nonredundant_KEGG.pdf",width = 15,height = 10)
